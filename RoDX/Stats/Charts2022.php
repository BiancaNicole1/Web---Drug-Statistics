...
$sql2 = "SELECT * FROM 2022_criminality_applied_penalties";
...
$sql3 = "SELECT * FROM 2022_criminality_convictions";
...
$sql4 = "SELECT * FROM 2022_criminality_convictions_gender_age";
...
$sql5 = "SELECT * FROM 2022_medical_emergencies_administrare";
...
$sql6 = "SELECT * FROM 2022_medical_emergencies_age";
...
$sql7 = "SELECT * FROM 2022_medical_emergencies_diagnostic";
...
$sql8 = "SELECT * FROM 2022_medical_emergencies_gender";
...
$sql9 = "SELECT * FROM 2022_confiscations";
...
<div class="charts-container">
    <div class="chart-item">
        <div class="chart-title">Criminality in 2022</div>
