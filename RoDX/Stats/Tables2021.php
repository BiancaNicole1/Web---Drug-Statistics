...
<head>
    ...
    // tabel 1
    $sql1 = "SELECT * FROM 2021_confiscations"; 
...
$sql2 = "SELECT * FROM 2021_criminality"; 
...
$sql3 = "SELECT * FROM 2021_criminality_applied_penalties"; 
...
$sql4 = "SELECT * FROM 2021_criminality_convictions"; 
...
$sql5 = "SELECT * FROM 2021_Criminality_convictions_gender_age"; 
...
$sql6 = "SELECT * FROM 2021_medical_emergencies_administrare"; 
...
$sql7 = "SELECT * FROM 2021_medical_emergencies_age"; 
...
$sql8 = "SELECT * FROM 2021_medical_emergencies_diagnostic"; 
...
$sql9 = "SELECT * FROM 2021_medical_emergencies_gender";
